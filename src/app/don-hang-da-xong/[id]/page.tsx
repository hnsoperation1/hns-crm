  ...
  if (!opp) {
    return (
      <div className="p-12 text-center">
        ...
        <Link href="/don-hang-da-xong" className="text-accent-500 hover:underline text-sm">← Quay lại Đơn hàng</Link>
      </div>
    )
  }
    ...
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-gray-200 bg-white flex-shrink-0">
        <div className="flex items-center gap-1.5 text-xs text-gray-400 mb-3">
          ...
          <span>/</span>
          <Link href="/don-hang-da-xong" className="hover:text-gray-600">Đơn hàng</Link>
          <span>/</span>
          <span className="text-gray-700 font-medium truncate">{opp.title}</span>
        </div>

        <div className="flex items-start gap-3">
          <Link href="/don-hang-da-xong" className="mt-1 p-1.5 rounded-lg hover:bg-gray-100 text-gray-400 transition-colors flex-shrink-0">
            <ArrowLeft size={18} />
          </Link>
