...
import { STAGE_LABELS, STAGE_COLORS, formatDate, formatVND, getInitials, daysUntil } from '@/lib/utils'
...
export default function DangThucHienPage() {
  ...
  const cols = ['Đơn hàng', 'Giai đoạn', 'Sale TV', 'Điểm đến', 'Ngày đi', 'Ngày về', 'Còn lại', 'Giá trị']
          ...
          {loading ? (
            Array.from({ length: 8 }).map((_, i) => (
              <tr key={i} className="animate-pulse">
                {[38, 16, 18, 20, 12, 12, 10, 12].map((w, j) => (
